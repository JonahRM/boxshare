class SpecificationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @specification.save
        format.html { render 'groups/show', notice: 'Specification was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @specification.update(specification_params)
        format.html { render 'groups/show', notice: 'Specification was successfully updated.' }
  ...
  private
    ...
    def specification_params
      params.require(:specification).permit(:comment, :will_use, :user_id, :game_id, :group_id)
    end
end
